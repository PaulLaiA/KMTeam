...
**Previous** :: [[Study_dPaul/Golang/Go 基礎教學/1-3-2|切片 Slice]]
...
[哈希表](https://en.wikipedia.org/wiki/Hash_table)是一种古老的数据结构，在 1953 年就有人使用拉链法实现了哈希表，它能够通过键直接获取该键对应的值。

## 设计原理

哈希表是计算机科学中的最重要数据结构之一，这不仅因为它`O(1)` 的读写性能非常优秀，还因为它提供了键值之间的映射。想要实现一个性能优异的哈希表，需要注意两个关键点 —— **哈希函数**和**冲突解决方法**。
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161309.png]]

**图 1 完美哈希函数**

比较实际的方式是让哈希函数的结果能够尽可能的均匀分布，然后通过工程上的手段解决哈希碰撞的问题。哈希函数映射的结果一定要尽可能均匀，结果不均匀的哈希函数会带来更多的哈希冲突以及更差的读写性能。

![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161314.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161325.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161336.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161344.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161351.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161403.png]]
...
这里展开的两个切片 `vstatk` 和 `vstatv` 还会被编辑器继续展开，具体的展开方式可以阅读上一节了解[[Study_dPaul/Golang/Go 基礎教學/1-3-2#初始化|切片 Slice 的初始化]]，不过无论使用哪种方法，使用字面量初始化的过程都会使用 Go 语言中的关键字 `make` 来创建新的哈希并通过最原始的 `[]` 语法向哈希追加元素。
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161415.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161424.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161437.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161449.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161458.png]]
...
![[Study_dPaul/Golang/Go 基礎教學/_annex/Pasted image 20211103161509.png]]
